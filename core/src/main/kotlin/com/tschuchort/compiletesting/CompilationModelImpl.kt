...
sealed class CompilationModelImpl : CompilationModel {
    ...
    internal class JvmCompilationModelImpl : CompilationModelImpl(), JvmCompilationModel {
        ...
        override var kaptArgs: MutableMap<OptionName, OptionValue> = mutableMapOf()

        /** Annotation processors to be passed to kapt */
        override var annotationProcessors: List<Processor> = emptyList()
        ...
        override val kaptBaseDir get() = workingDir.resolve("kapt")

        // Java annotation processors that are compile by kapt will put their generated files here
        override val kaptSourceDir get() = kaptBaseDir.resolve("sources")

        // Output directory for Kotlin source files generated by kapt
        override val kaptKotlinGeneratedDir get() = kaptArgs[OPTION_KAPT_KOTLIN_GENERATED]
            ?.let { path ->
        ...
        override val kaptStubsDir get() = kaptBaseDir.resolve("stubs")
        override val kaptIncrementalDataDir get() = kaptBaseDir.resolve("incrementalData")
    }
